                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="glass-card">
                            ...
                            <div class="settings-panel">
                                ...
                                <div class="setting-item">
                                    ...
                                    <small class="form-text text-muted"
                                        ...
                                        Tanggal otomatis terisi waktu sekarang. Bisa disesuaikan manual.
                                    </small>
                                    @error('published_at')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div style="margin-top: 24px; display: flex; flex-direction: column; gap: 12px;">
                                ...
                                <button type="button" class="btn-modern btn-outline" onclick="saveDraft()">
                        ...
                        <div class="glass-card">
                            <div class="card-title-header">
                                ...
                                <h4>Tips Menulis Berita</h4>
                            </div>

                            <div class="tips-panel">
                                <ul class="tips-list">
                                    <li>Gunakan judul yang menarik dan informatif</li>
                                    <li>Mulai dengan lead yang kuat (5W+1H)</li>
                                    <li>Gunakan bahasa yang mudah dipahami</li>
                                    <li>Sertakan gambar yang relevan dan berkualitas</li>
                                    <li>Periksa ejaan dan tata bahasa</li>
                                    <li>Gunakan paragraf pendek untuk kemudahan baca</li>
                                    <li>Tambahkan quote atau data pendukung</li>
                                    <li>Akhiri dengan kesimpulan yang jelas</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Auto-set current datetime if field is empty
            function setCurrentDateTime() {
                if (!publishedAtInput.value) {
                    ...
                    publishedAtInput.value = formattedDateTime;
                }
            }
            ...
            // Update datetime when user clicks on the input (if still empty)
            publishedAtInput.addEventListener('focus', function() {
                if (!this.value) {
                    setCurrentDateTime();
                }
            });
            ...
            contentEditor.addEventListener('input', startAutoSave);
            ...
            if (savedDraft && !titleInput.value && !contentEditor.innerHTML.trim()) {
                const draft = JSON.parse(savedDraft);
                const draftAge = (new Date() - new Date(draft.timestamp)) / (1000 * 60); // minutes

                if (draftAge < 60) { // Less than 1 hour old
        ...
        function alignText(command) {
            // command sudah berupa 'justifyLeft', 'justifyCenter', dll
            document.execCommand(command, false, null);
            document.getElementById('content-editor').focus();
        }
